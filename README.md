...
3. In the **journey** module, there is a `journeyMaker()` function. In that function, there is a variable named `areas` which will have the value of an object. Use your debugger to show what the value of each key is on that object. Use [Loom](https://www.loom.com) to record your session.
   ...
   Also I do apologize to keep calling them keys when they are objects after their description as together they an object, was a little nervous. Also it is the for loop on line 33 of the journey module that takes that number and loops it through and pushes the string(of their respectful wilderness adventures) into the empty array journey on line 24. This is where the number values are given their string counterpart to display in the debugger.
